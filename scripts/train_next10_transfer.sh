...
OUTPUT_ROOT="${OUTPUT_ROOT:-artifacts/experiments/next10_positive_fast_transfer}"
START_WEIGHTS="${START_WEIGHTS:-artifacts/weights/trained.pt}"
FINAL_WEIGHTS="${FINAL_WEIGHTS:-artifacts/weights/trained_next10_positive.pt}"
DEVICE="${DEVICE:-cpu}"
BATCH="${BATCH:-4}"
EPOCHS="${EPOCHS:-10}"
PATIENT_COUNT="${PATIENT_COUNT:-10}"
PATIENT_OFFSET="${PATIENT_OFFSET:-10}"
