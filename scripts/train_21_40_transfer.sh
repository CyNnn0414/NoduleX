...
OUTPUT_ROOT="${OUTPUT_ROOT:-artifacts/experiments/patients21_40_positive_fast_transfer}"
START_WEIGHTS="${START_WEIGHTS:-artifacts/weights/trained_next10_positive.pt}"
FINAL_WEIGHTS="${FINAL_WEIGHTS:-artifacts/weights/trained_21_40_positive.pt}"
DEVICE="${DEVICE:-cpu}"
BATCH="${BATCH:-4}"
EPOCHS="${EPOCHS:-10}"
PATIENT_COUNT="${PATIENT_COUNT:-20}"
PATIENT_OFFSET="${PATIENT_OFFSET:-20}"
