...
OUTPUT_ROOT="${OUTPUT_ROOT:-artifacts/experiments/first10_positive_fast_transfer}"
START_WEIGHTS="${START_WEIGHTS:-artifacts/weights/best.pt}"
FINAL_WEIGHTS="${FINAL_WEIGHTS:-artifacts/weights/trained.pt}"
DEVICE="${DEVICE:-cpu}"
BATCH="${BATCH:-4}"
EPOCHS="${EPOCHS:-10}"
